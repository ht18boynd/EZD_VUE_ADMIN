                ...
                >
                  <div class="carousel-inner">
                    <div class="carousel-item active">
                      <img
                        src="assets/images/gallery/17.png"
                        class="d-block w-100"
                        alt="..."
                      />
                    </div>
                    <div class="carousel-item">
                      <img
                        src="assets/images/gallery/18.png"
                        class="d-block w-100"
                        alt="..."
                      />
                    </div>
              ...
              <div class="card-body">
                ...
                >
                  <div class="carousel-inner">
                    ...
                    <div class="carousel-item">
                      <img
                        src="assets/images/gallery/22.png"
                        class="d-block w-100"
                        alt="..."
                      />
                    </div>
              ...
              <div class="card-body">
                ...
                >
                  ...
                  <div class="carousel-inner">
                    ...
                    <div class="carousel-item">
                      <img
                        src="assets/images/gallery/24.png"
                        class="d-block w-100"
                        alt="..."
                      />
                    </div>
                    <div class="carousel-item">
                      <img
                        src="assets/images/gallery/25.png"
                        class="d-block w-100"
                        alt="..."
                      />
                    </div>
              ...
              <div class="card-body">
                ...
                >
                  ...
                  <div class="carousel-inner">
                    <div class="carousel-item active">
                      <img
                        src="assets/images/gallery/26.png"
                        class="d-block w-100"
                        alt="..."
                      />
                    ...
                    <div class="carousel-item">
                      <img
                        src="assets/images/gallery/27.png"
                        class="d-block w-100"
                        alt="..."
                      />
                      <div class="carousel-caption d-none d-md-block">
                    ...
                    <div class="carousel-item">
                      <img
                        src="assets/images/gallery/28.png"
                        class="d-block w-100"
                        alt="..."
                      />
                      <div class="carousel-caption d-none d-md-block">
              ...
              <div class="card-body">
                ...
                >
                  <div class="carousel-inner">
                    <div class="carousel-item active">
                      <img
                        src="assets/images/gallery/29.png"
                        class="d-block w-100"
                        alt="..."
                      />
                    </div>
                    <div class="carousel-item">
                      <img
                        src="assets/images/gallery/30.png"
                        class="d-block w-100"
                        alt="..."
                      />
                    </div>
                    <div class="carousel-item">
                      <img
                        src="assets/images/gallery/31.png"
                        class="d-block w-100"
                        alt="..."
                      />
                    </div>
                ...
                >
                  <div class="carousel-inner">
                    <div class="carousel-item active" data-bs-interval="10000">
                      <img
                        src="assets/images/gallery/32.png"
                        class="d-block w-100"
                        alt="..."
                      />
                    </div>
                    <div class="carousel-item" data-bs-interval="2000">
                      <img
                        src="assets/images/gallery/33.png"
                        class="d-block w-100"
                        alt="..."
                      />
                    </div>
                    <div class="carousel-item">
                      <img
                        src="assets/images/gallery/34.png"
                        class="d-block w-100"
                        alt="..."
                      />
                    </div>
