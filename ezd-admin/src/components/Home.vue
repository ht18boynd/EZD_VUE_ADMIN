<template>
  ...
  <div>
            ...
            >
              <div class="card-body">
                <div class="d-flex align-items-center">
                  <div>
                    <p class="mb-0 text-secondary">New Game</p>
          ...
          <div class="col">
            ...
            >
              <div class="card-body">
                <div class="d-flex align-items-center">
                  <div>
                    <p class="mb-0 text-secondary">New Banner</p>
          ...
          <div class="col">
            ...
            >
              <div class="card-body">
                <div class="d-flex align-items-center">
                  <div>
                    <p class="mb-0 text-secondary">New Contact</p>
          ...
          <div class="col">
            ...
            >
              <div class="card-body">
                <div class="d-flex align-items-center">
                  <div>
                    <p class="mb-0 text-secondary">New Blog</p>
          ...
          <div class="col-12 col-lg-6 d-flex">
            <div class="card radius-10 w-100">
              <div class="card-header">
                <div class="d-flex align-items-center">
                  <div>
                    <h6 class="mb-0">Biểu Đồ Các Account</h6>
                  </div>
                </div>
              </div>
              <div class="card-body">
              ...
              >
                <div class="col">
                  <div class="p-3">
                    <h5 class="mb-0">{{ userCountByRole.USER }}</h5>
                    <span class="mb-0"> Tổng Số User</span>
                  </div>
                </div>
                <div class="col">
                  <div class="p-3">
                    <h5 class="mb-0"> {{ userCountByRole.STAFF }}</h5>
                    <span class="mb-0">Tổng Số Idol</span>
                  </div>
                </div>
                <div class="col">
                  <div class="p-3">
                    <h5 class="mb-0">{{ userCountByRole.USER + userCountByRole.STAFF }}</h5>
                    <span class="mb-0">
                      Tổng Số Account 
                    </span>
                  </div>
    ...
    <footer class="page-footer">
      <p class="mb-0">Copyright © 2023. Make By V.</p>
    </footer>
  </div>
  <!--end wrapper-->
...
export default {
  ...
  setup() {
    const userCountByRole = ref({ USER: 0, STAFF: 0 });
    const UserList = ref([]);
    ...
    const findByEmail = async (email) => {
      try {
        const response = await AuthService.findByEmail(email);
    ...
    const renderChart = () => {
      ...
      const config = {
        ...
        data: {
          ...
          datasets: [
            {
              data: Object.values(userCountByRole.value),
              backgroundColor: ["rgb(20, 171, 239)", "rgb(255, 193, 7)"],
            },
          ],
        },
        options: {
    ...
    const getAllUsers = async () => {
      try {
        const response = await AuthService.getAllAccount();
        UserList.value = response;
        totalItems.value = UserList.value.length;
        isDataLoaded.value = true;
        UserList.value.forEach((user) => {
          if (user.role === "USER") {
            userCountByRole.value.USER++;
          } else if (user.role === "STAF") {
            userCountByRole.value.STAFF++;
          }
        });
